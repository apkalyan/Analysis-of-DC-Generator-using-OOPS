...
class Transformer(ABC):
    ...
    def __init__(self):
        # Default rated current and voltage
        ...
        # Input values for open circuit and short circuit tests
        while True:
            try:
    ...
    # Abstract method for calculating total losses
    @abstractmethod
    ...
    # Method to calculate regulation
    ...
    # Method to calculate and display transformer characteristics
    def calculate(self):
        ...
        if efficiency >= 90:
            ...
            sound=(u'C:\\Users\\kalya\\OneDrive\\Desktop\\trans.mp3')
            playsound(sound)
...
class SpecificTransformer(Transformer):
    # Implement specific calculations if needed
    def calculate_total_losses(self):
        pass
